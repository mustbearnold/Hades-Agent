...
|---|---|---|---|
| HANDOFF-2026-08-05.md | repo root | Session handoff (night 08-05 → morning 08-06); one-off working state, no home in SDD structure | Read by morning agent, then human decides: delete or keep in _attic |
...
| docs/parity/HERMES-SLASH-COMMANDS.md | docs/parity/ | Reference capture; no doc category | Review |
| docs/PRODUCT_SPEC.md | docs/ | Content merged into specs/001 | Delete |
