...
| Full setup model default to terminal backend | Observed | [OBS-0048](observations/OBS-0048-hermes-model-default-terminal-backend-2026-08-01.md) | — | HAD-049 / Future task |
