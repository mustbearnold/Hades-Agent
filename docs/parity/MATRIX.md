...
| Slash-command configuration surfaces (bounded subset) | Observed | [OBS-0036](observations/OBS-0036-hermes-slash-command-surfaces-2026-08-01.md) | [unknown-command replay](observations/OBS-0037-hades-unknown-slash-command-2026-08-01.md) (bounded error path only) | HAD-037 / HAD-038 / Future task |
