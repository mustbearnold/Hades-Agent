#!/usr/bin/env python3
"""Replay the implemented Hades slash-completion contract in isolated tmux PTYs."""
...
DEFAULT_CONTRACT = ROOT / "tests/fixtures/parity/OBS-0012-hades-slash-completion.json"
        ...
        for ordinal, case in enumerate(contract["cases"], start=1):
            checks.append(
                run_case(
                    ...
                    arguments.timeout,
                    ordinal,
                    session_prefix="had012-completion",
                )
            )
        report["passed"] = True
