#!/usr/bin/env python3
"""Replay the implemented Hades bracketed-paste contract in an isolated tmux PTY."""
...
DEFAULT_CONTRACT = ROOT / "tests/fixtures/parity/OBS-0013-hades-bracketed-paste.json"
