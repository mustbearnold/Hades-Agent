#!/usr/bin/env python3
"""Replay the implemented Hades unchanged-draft editor contract in a tmux PTY."""
...
DEFAULT_CONTRACT = ROOT / "tests/fixtures/parity/OBS-0014-hades-editor-handoff.json"
