...
# ============================================================
# Replay section. All replay binaries build ONCE (cargo
# parallelizes); reference probes (live Hermes, pinned checkout)
# and timing-sensitive replays (500 ms race windows) run first,
# serial; the remaining replay units run with bounded
# parallelism (each unit: differential parity + gate run).
# ============================================================
cargo build --offline --package hades-dev --bins
...
run_replay_unit() {
    case "$1" in
        ...
        replay_standalone_full_setup)
            ...
            ;;
        replay_standalone_terminal_platform)
            ...
            ;;
        replay_standalone_empty_platform_confirmation)
            ...
            ;;
        replay_standalone_tool_provider_boundary)
            ...
            ;;
        replay_standalone_tool_provider_inventory)
            ...
            ;;
        replay_standalone_tool_provider_inventory_navigation)
            ...
            ;;
        replay_standalone_tool_provider_inventory_selection)
        ...
        replay_configured_help)
            ...
            ;;
        replay_configured_help_lifecycle)
        ...
        replay_fresh_shell_launch)
            ...
            ;;
        replay_installed_model_selection)
        ...
        replay_setup_provider_menu)
            ...
            ;;
        replay_setup_provider_model_prompt)
        ...
        replay_local_provider)
            ...
            ;;
        *)
            echo "[verify] unknown replay unit: $1" >&2
            return 1
            ;;
    esac
}
